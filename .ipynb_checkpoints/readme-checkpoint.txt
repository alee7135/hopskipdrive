This goal of this project is to build a prototype data science solution that will optimize rides to be claimed earlier and for trip boosting costs to be minimzed. I proposed a model that predicts elasticity for time it takes to claim rides and then use the elasticity to simulate different scenarios of boost cost and claim times in order to select the optimal based on a default multi-objective function.
